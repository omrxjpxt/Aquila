...
from app.schemas.source_health import SystemStatusResponse
...
async def get_status():
    """
    Returns consolidated system health, persistence configuration, and rich intelligence source statuses.
    """
    from app.services.source_health_service import SourceHealthService
    return await SourceHealthService.get_system_status()
