...
class AttributionService:
    ...
    def evaluate(self, investigation_id: str, origin: OriginEstimate, drift: DriftResult, candidates: List[VesselCandidate]) -> AttributionResult:
        ...
        for cand in candidates:
            ...
            if qual == "GOOD":
                ...
                status = EvidenceStatus.CONTRADICTING # or neutral? We treat poor quality as neutral score, but label it.
