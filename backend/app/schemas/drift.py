...
class DriftScenario(BaseModel):
    ...
    release_window_hours: float = Field(default=0.0, description="Duration of continuous release in hours, if applicable")
...
class DriftProvenance(BaseModel):
    ...
    limitations: str = Field(default="This trajectory is generated for development/demo purposes and is not a physically validated oil-spill forecast.")
